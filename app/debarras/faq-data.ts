...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Tout est trié : ce qui peut être revendu part dans notre boutique solidaire, le reste est orienté vers les filières de recyclage adaptées. Rien ne finit inutilement à la déchetterie.",
  },
  {
    q: "Combien de temps dure un débarras ?",
    a: "Ça dépend du volume. Un grenier standard se vide en quelques heures. On définit ensemble un créneau adapté lors de notre visite préalable.",
  },
]
