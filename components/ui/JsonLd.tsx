...
export default function JsonLd() {
  const schema = {
    ...
    description: `${SITE.slogan}. Recyclerie-Ressourcerie associative à Brasles depuis 2014. Boutique de seconde main, dons d'objets et insertion professionnelle.`,
    url: BASE_URL,
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "8 avenue de Château-Thierry",
      addressLocality: "Brasles",
      postalCode: "02410",
