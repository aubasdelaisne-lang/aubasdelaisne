...
export default function Atelier({ className = "" }: Props) {
  return (
    <svg viewBox="0 0 240 160" fill="none" className={className} aria-hidden="true">
      {/* Étincelles */}
      <path d="M52 26 L55 35 L64 38 L55 41 L52 50 L49 41 L40 38 L49 35 Z" fill={P.terracotta} />
      <path d="M190 18 L192.5 25 L200 27.5 L192.5 30 L190 37 L187.5 30 L180 27.5 L187.5 25 Z" fill={P.terracottaSoft} />
      <path d="M216 68 L218 74 L224 76 L218 78 L216 84 L214 78 L208 76 L214 74 Z" fill={P.terracotta} />
